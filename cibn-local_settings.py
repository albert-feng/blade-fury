...
#cms_server = {
#    'server': '10.103.13.132:6100',
#}

cms_server = {
    'server': '10.100.188.42'
}

ycew_cms_server = {
    # 'server': '10.100.14.83:6800',
    'server': '10.100.27.133:81',
}
...
cms_update_latest_server = '10.100.188.6:8080' #只检查更新接口使用
...
# m3u8播放地址使用域名
playapi_server = 'pl.cp31.ott.cibntv.net'
# m3u8 play 开关
...
#是否打开广告:True有广告, False无广告
open_advertisement = False

#配置客户端访问的域名
use_domain_name = 0
domain_name = {
        'common':'http://cibn.api.3g.cp31.ott.cibntv.net/',
        'user':'http://user.cibn.api.3g.cp31.ott.cibntv.net/',
        'playlog': 'http://yus.navi.cp31.ott.cibntv.net/',
        'statis': 'http://statis.api.3g.cp31.ott.cibntv.net/',
        'store': 'http://store.tv.api.3g.cp31.ott.cibntv.net/',
        'soku': 'http://p.l.cp31.ott.cibntv.net/',
        'bms': 'http://bms.xl.api.3g.cp31.ott.cibntv.net/',
}
...
video_delete_image = 'http://g3.cp31.ott.cibntv.net/053201015367515E0A8C84685EAA0D52'
video_shield_image = 'http://g1.cp31.ott.cibntv.net/053201015367515E0A8C84685E13EBA2'
...
show_fields_code = {
    ...
    'etot':'episode_total',
    'elas':'episode_last',
    'chketot':'check_episode_total',
    'chkelas':'check_episode_last',
    'chkefst':'check_episode_first',
    'sturl':'show_thumburl',
    'svturl': 'show_vthumburl',
    'sburl': 'show_bannerurl',
    'fvid': 'firstepisode_videoid',
    'lvid': 'lastepisode_videoid',
    'chkfvid': 'check_firstepisode_videoid',
    'chklvid': 'check_lastepisode_videoid',
...
category_map = {84: u'纪录片', 96: u'电影', 97: u'电视剧', 85: u'综艺', 90: u'母婴', 91: u'资讯', 98: u'体育', 104: u'汽车', 105: u'科技', 86: u'娱乐', 92: u'原创', 95: u'音乐', 99: u'游戏', 89: u'时尚', 88: u'旅游', 94: u'搞笑', 100: u'动漫', 102: u'广告', 103: u'生活',87:u'教育', 669:u'少儿'}
CHANNEL_ART = 85
CHANNEL_EDU = 87
CHANNEL_TV = 97
CHANNEL_ANIME = 100
...
#soku
source_icon = {1:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6DB6714C043FD068F90', 2:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6766714C043F40D7651', 3:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6CC6714C0448B0B8C52', 6:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6D36714C043FC05265B', 9:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B68F6714C047A607D02B', 14:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6E16714C043FE0E5FD2', 15:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6826714C044D4018B05', 16:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6A26714C0448A033E1E', 17:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6996714C047A706B102', 19:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6C06714C067A203AA00', 27:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6C46714C043FA024F3E', 31:u'http://res.mfs.cp31.ott.cibntv.net/051000005029B6B96714C043F905A533'}
